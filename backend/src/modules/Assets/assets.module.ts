...
export const createAssetUseCase = new CreateAssetUseCase(
    assetsRepository,
    brandsRepository,
    foldersRepository,
    storageProvider,
...
export const updateAssetUseCase = new UpdateAssetUseCase(
    assetsRepository,
    brandsRepository,
    foldersRepository,
    storageProvider,
...
export const deleteAssetUseCase = new DeleteAssetUseCase(
    assetsRepository,
    storageProvider,
    auditLogService
);
