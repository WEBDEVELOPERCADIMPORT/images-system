...
export const createFolderUseCase = new CreateFolderUseCase(foldersRepository, brandsRepository, createAuditLogUseCase);
...
export const updateFolderUseCase = new UpdateFolderUseCase(foldersRepository, createAuditLogUseCase);
export const deleteFolderUseCase = new DeleteFolderUseCase(foldersRepository, createAuditLogUseCase);
